        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold">Pack & Go</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/umzug" className="text-gray-300 hover:text-white">
                  Umzug Deutschland
                </Link>
              </li>
              <li>
                <Link href="/auslandsumzug" className="text-gray-300 hover:text-white">
                  Auslandsumzug
                </Link>
              </li>
              <li>
                <Link href="/preise" className="text-gray-300 hover:text-white">
                  Preise
                </Link>
              </li>
              <li>
                <Link href="/bewertungen" className="text-gray-300 hover:text-white">
                  Bewertungen
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/ueber-uns" className="text-gray-300 hover:text-white">
                  Über uns
                </Link>
              </li>
              <li>
